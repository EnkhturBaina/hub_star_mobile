	...
	return (
		<View style={{ backgroundColor: MAIN_BG_GRAY, flex: 1, paddingHorizontal: 20 }}>
			<Text className="font-bold mb-5">
				Таньд баталгаажуулах код ирэх тул утасны дугаар эсвэл И-мэйл ээ бичиж оруулна уу?
			</Text>
			...
			<View className="mt-5 ">
				<GradientButton text="Код илгээх" action={() => props.navigation.navigate("OTPScreen")} />
			</View>
		</View>
	);
};
